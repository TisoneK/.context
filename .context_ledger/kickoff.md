...
- **Project repository URL:** https://github.com/TisoneK/context-ledger.git
- **Project repo privacy:** Public
- **Default branch:** main
- **Live application:** N/A (protocol package — no runtime)
...
- **Package upstream (core updates + flaw back-ports):** https://github.com/TisoneK/context-ledger.git — this repo **is** the package; self-hosted (see README, "Working on this repo")
