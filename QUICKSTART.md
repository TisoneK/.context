...
- **One protocol package repo** — `TisoneK/.context`, cloned at
  `~/Code/ai-engineering-protocol`. Holds the two protocol editions,
...
├── context-skeleton/                 14-file stub tree
...
```bash
git clone https://github.com/TisoneK/.context.git ~/Code/ai-engineering-protocol
```
...
cp -r ~/Code/ai-engineering-protocol/context-skeleton .context
