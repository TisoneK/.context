...
- If `.context_ledger/` exists, read it in this order:
  ...
  2. `.context_ledger/memory/office/agents/sessions.md` — who worked here before, with which model, on which machine, and what they did (read the last 3–5 entries)
